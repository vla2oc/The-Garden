...
import VideoSmaku from "./lib/VideoSmaku";
  ...
  return (
    <>
      <section className="relative bg-black  overflow-hidden">
        ...
        <div className="container mx-auto px-3 md:px-10 pb-20 pt-30">
          <div className="mb-10">
            <AnimatedTitle
              title={["Menu"]}
          ...
          <div className="grid h-[85vh] grid-cols-1 md:grid-cols-2 grid-rows-2 gap-15">
